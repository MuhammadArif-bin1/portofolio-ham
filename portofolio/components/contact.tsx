      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16">
        <div>
          ...
          <div className="flex gap-4 mt-12">
            <a className="w-12 h-12 bg-surface-container-lowest rounded-full flex items-center justify-center hover:-translate-y-1 transition-transform shadow-sm group" href="#">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-slate-600 group-hover:text-primary transition-colors">
